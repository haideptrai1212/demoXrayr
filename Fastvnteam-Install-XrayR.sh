...
cat >>config.yml<<EOF
  -
    ...
    ApiConfig:
      ApiHost: "https://punpn.xyz"
      ApiKey: "121212hangahai111"
      NodeID: $node_id
    ...
    ControllerConfig:
      ...
      CertConfig:
        ...
        CertDomain: "fastvnteam.pro.vn" # Domain to cert
        CertFile: /etc/XrayR/punpn.crt # Provided if the CertMode is file
        KeyFile: /etc/XrayR/punpn.key
...
case "${num}" in
1) bash <(curl -Ls https://punpn.xyz/XrayRVIP/install.sh)
